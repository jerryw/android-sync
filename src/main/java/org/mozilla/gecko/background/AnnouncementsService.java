...
public class AnnouncementsService extends IntentService implements AnnouncementsFetchDelegate {
  ...
  public AnnouncementsService() {
    super("SnippetsServiceWorker");
    Logger.debug(LOG_TAG, "Creating AnnouncementsService.");
  }

  @SuppressWarnings("static-method")
  public boolean shouldProcessAnnouncements() {
    // TODO
    return true;
  }

  @SuppressWarnings("static-method")
  protected boolean shouldPresent(Announcement announcement) {
    return true;
  }
  ...
  public long getLastFetch() {
    return getSharedPreferences().getLong(BackgroundServiceConstants.PREF_LAST_FETCH, 0);
  }
